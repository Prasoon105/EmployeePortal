...
public class EmployeeController {
    ...
    public ResponseEntity<?> getEmployeesByProjectIdc(@PathVariable Long projectId) {
        ...
        return ResponseEntity.ok(new EmployeeProjectResponseDTO(employees, employeeCount));
    }
    
    @PostMapping("/{employeeId}/assign-department/{departmentId}")
    public ResponseEntity<Map<String, String>> assignDepartmentToEmployee(
        ...
        try {
            ...
            Map<String, String> responseMessage = new HashMap<>();
            responseMessage.put("message", "Department assigned to employee successfully!");
            responseMessage.put("employeeId", String.valueOf(updatedEmployee.getEmpId()));
            responseMessage.put("departmentId", String.valueOf(updatedEmployee.getDepartment().getDepId()));
